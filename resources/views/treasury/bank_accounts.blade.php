...
.bm-badge-php { background: #DBEAFE; color: #1D4ED8; }
.bm-badge-usd { background: #DCFCE7; color: #15803D; }
...
.cur-tab { padding: .35rem .9rem; border-radius: 6px; font-size: .76rem; font-weight: 600;
           cursor: pointer; border: 1px solid var(--line); background: var(--surface); color: var(--body);
           transition: all .15s; }
.cur-tab.active { background: #DBEAFE; border-color: var(--line); color: #1D4ED8; }
</style>
